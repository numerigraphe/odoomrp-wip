...
class StockProductionLot(models.Model):
    ...
    def _get_locked_value(self):
        return self.product_id.categ_id.parent_lot_default_locked
    ...
    def onchange_product_id(self):
        self.locked = self.product_id.categ_id.parent_lot_default_locked
    ...
    def create(self, vals):
        ...
        vals['locked'] = product.categ_id.parent_lot_default_locked
    ...
    def write(self, values):
        if 'product_id' in values:
            ...
            values['locked'] = product.categ_id.parent_lot_default_locked
